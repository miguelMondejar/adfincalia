      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
          {services.map((s, i) => (
            <div
              key={i}
              className="p-8 bg-white rounded-2xl shadow-md hover:shadow-2xl transition flex flex-col items-center h-full group hover:border-t-4 hover:border-t-[#5AAD94]"
            >
              <div className="w-16 h-16 bg-[#5AAD94] rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition">
        ...
        <div className="mt-16 bg-gradient-to-r from-[#5AAD94] to-[#A47C48] rounded-lg p-10 shadow-lg text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white bg-opacity-10 p-6 rounded-lg backdrop-blur">
              <p className="font-bold text-lg mb-2 text-yellow-300">📌 Experiencia</p>
              <p className="text-gray-100">Años de trayectoria probada en el sector inmobiliario español</p>
            </div>
            <div className="bg-white bg-opacity-10 p-6 rounded-lg backdrop-blur">
              <p className="font-bold text-lg mb-2 text-yellow-300">👥 Profesionalismo</p>
              <p className="text-gray-100">Equipo cualificado y dedicado a tu satisfacción</p>
            </div>
            <div className="bg-white bg-opacity-10 p-6 rounded-lg backdrop-blur">
              <p className="font-bold text-lg mb-2 text-yellow-300">🔒 Confianza</p>
          ...
          <button
            ...
            className="bg-white text-[#5AAD94] px-8 py-4 rounded-full font-bold hover:bg-gray-100 transition flex items-center gap-3 text-lg shadow-lg hover:shadow-2xl hover:scale-105 duration-300 mx-auto"
          >
